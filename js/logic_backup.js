...
openMediaWithPlayer(url, mediaType, title = 'Vídeo') {
                ...
                // 2) Nome relativo: completa contra as pastas configuradas (Filmes/Séries).
                if (url && !/^(https?:|file:|blob:|[A-Za-z]:[\\\/]|\\\\|\/)/.test(url)) {
                    ...
                    for (var bi = 0; bi < bases0.length; bi++) {
                        ...
                        try {
                            if (typeof require !== 'undefined') {
                                if (require('fs').existsSync(cand0)) { url = cand0; break; }
                            } else {
                                url = cand0;
                                break;
                            }
